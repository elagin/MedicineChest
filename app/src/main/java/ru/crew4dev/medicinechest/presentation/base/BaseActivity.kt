...
import ru.crew4dev.medicinechest.app.analytics.HockeyAppActivity
import ru.crew4dev.medicinechest.presentation.base.dialog.BaseDialog

abstract class BaseActivity : HockeyAppActivity() {
    ...
    fun showError(@StringRes textResId: Int) = showDialogError(textResId)

    private fun showDialogError(@StringRes textResId: Int) =
        BaseDialog.newInstance(
            name = textResId.toString(),
            title = textResId,
